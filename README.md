# SipMask/SipMask++ Real-time Instance Segmentation
This is a Tensorflow 2.3 implementation of the paper [SipMask: Real-time Instance Segmentation](https://arxiv.org/abs/2007.14772) and [SipMask++: Better Real-time Instance Segmentation](https://arxiv.org/abs/2007.14772).This Repo implements "ResNet50-FPN", "ResNet101-FPN" along with DCNv2.<br/>
